...
var MAC={
    ...
    'User':{
        ...
        'Login':function(){
            ...
            MAC.Pop.Show(300,280,'欢迎您的到来!',maccms.path+'/index.php/user/'+ac,function(r){
    ...
    'Pop':{
        ...
        'Show':function($w,$h,$title,$url,$callback) {
            ...
            $('body').append('<div class="mac_pop fadeInUp animated"><div class="pop_top"><h2></h2><span class="pop_close fa fa-remove iconfont"></span></div><div class="line"></div><div class="pop_content"></div></div>');
